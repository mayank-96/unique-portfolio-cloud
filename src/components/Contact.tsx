...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 relative">
      {/* Gradient background */}
      <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-secondary/50 to-transparent"></div>
      <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-10 -left-20 w-72 h-72 bg-blue-500/5 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            {isSubmitted ? (
              <div className="bg-green-500/10 text-green-600 p-4 rounded-lg mb-6 flex items-center gap-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-3 bg-primary text-primary-foreground font-medium rounded-lg flex items-center justify-center hover:bg-primary/90 transition-colors disabled:opacity-70"
                >
                  {isSubmitting ? (
                    <>
